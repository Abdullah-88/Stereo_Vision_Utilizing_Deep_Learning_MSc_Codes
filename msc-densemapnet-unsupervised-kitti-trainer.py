...
densemap_model.load_weights('Training_Models/model_densemapnet_unsupervised_kitti.h5')
...
for e in range(epochs):
    ...
    densemap_model.save_weights('Training_Models/model_densemapnet_unsupervised_kitti.h5')
