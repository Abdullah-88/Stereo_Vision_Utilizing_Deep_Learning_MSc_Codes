...
expand_layer_conv = layers.SeparableConv2D(256, (4, 1), padding='same')(merge_layer)
...
callback_list = [keras.callbacks.ModelCheckpoint(
    filepath='Training_Models/model_convnet_supervised_kitti.h5',
...
history = depth_mapper.fit_generator(
    multi_train_generator(train_left_datagen, train_right_datagen, train_target_datagen), steps_per_epoch=150, epochs=1000,
