...
callback_list = [keras.callbacks.ModelCheckpoint(filepath='Training_Models/model_inception_supervised_mpi.h5',
...
history = depth_mapper.fit_generator(
    multi_train_generator(train_left_datagen, train_right_datagen, train_target_datagen), steps_per_epoch=900,
