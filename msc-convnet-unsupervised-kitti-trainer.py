...
decoder_model.load_weights('Training_Models/model_convnet_unsupervised_kitti.h5')
...
for e in range(epochs):
    ...
    decoder_model.save_weights('Training_Models/model_convnet_unsupervised_kitti.h5')
