...
model = models.load_model('Training_Models/model_densemapnet_supervised-mpi.h5')
model.summary()
preds = model.predict_generator(multi_test_generator(test_left_datagen, test_right_datagen), steps=63, verbose=0)
